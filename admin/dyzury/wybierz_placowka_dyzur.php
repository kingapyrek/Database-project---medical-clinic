	    ...
	    <div class="row">  
	      <div class="col-md-3" style="padding: 0px;">
		      ...
		      <h2 style="font-weight: bold;padding: 10px;">
		           Wybierz placówkę, w której chcesz dodać dyżur
		      </h2>
            <form role="form" method="get" action="wyswietl_poradnie_dyzur.php">
              <select class="form-select" aria-label="Default select example" name="placowka" style="padding: 5px; margin: 10px;"  required>
