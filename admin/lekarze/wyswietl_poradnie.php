  	...
  	<div class="container-fluid">
	    <div class="row">  
	      <div class="col-md-3" style="padding: 0px;">
              ...
              <h3  style="padding: 10px;">Wybierz poradnię </h3>
              <ul class="list-group list-group-flush">
              <?php
                include('../connect.php');
                
                $por = pg_query_params($dbconn, 'SELECT * FROM poradnia WHERE id_placowka=$1', array($id[0])) or die('Query failed: ' . pg_last_error());;
                ...
                while($row = pg_fetch_assoc($por))
                {
                  ...
                  ?>
                <li class="list-group-item"><a href="pokaz_lekarzy_poradnia.php?id=<?php echo $id[0] . "|" . $row['id_poradnia'] ?>"><?php echo $row_typ['nazwa'];?></a></li>
                    <?php } ?>
                </ul>
              </div>
    </div>
