            ...
            <ul id="menu-content" class="menu-content collapse out">
               <!-- <li>
                ...
                <ul class="sub-menu collapse" id="dyzury">
                  <li><a href="../dyzury/wybierz_placowka_gabinet.php">Wyświetl/dodaj gabinety do poradni</a></li>
                  <li><a href="../dyzury/wybierz_placowka_dyzur.php">Dodaj dyżur </a></li>
                  <li><a href="../dyzury/statystyki.php">Statystyki </a></li>
                </ul>
                ...
                <ul class="sub-menu collapse" id="pacjenci">
                  <li><a href="wyswietl_pacjenci.php">Wyświetl/edytuj pacjentów i ich dolegliwości</a></li>
                  <li><a href="wyswietl_leki.php">Wyświetl leki</a></li>
                </ul>
