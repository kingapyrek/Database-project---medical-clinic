  	...
  	<div class="container-fluid">
	    <div class="row">  
	        <div class="col-md-3" style="padding: 0px;">
             ...
             <form role="form" method="post" action="dodaj_placowka_baza.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="miasto" value=""  required/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Ulica</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="ulica" value=""  required/>
                    </div>
                </div>
                   <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="kod" value=""  required />
                    </div>
                </div>
                <div class="form-group row">
