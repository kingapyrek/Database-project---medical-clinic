	        ...
	        <div class="col-md-3" style="padding: 0px;">
		 	...
		 	<div class="col-md-8" style="margin-left: 370px;">
		        <h2 style="font-weight: bold;padding: 10px;">
		            Dodaj nowy typ poradni
		        </h2>
             <div class="col-lg-8 push-lg-4 personal-info">
             <form role="form" method="post" action="dodaj_typ_baza.php?id=<?php echo $id; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="form-control" name="opis" value="" style="text-indent:0;"  required></textarea>
                    </div>
                </div>
                <div class="form-group row">
