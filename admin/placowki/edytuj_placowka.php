  	...
  	<div class="container-fluid">
	    <div class="row">  
            ...
            ?>
             ...
             <form role="form" method="post" action="edytuj_placowka_baza.php?id=<?php echo $id; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="miasto" value="<?php echo $row_adres['miasto']; ?>"   required/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Ulica</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="ulica" value="<?php echo $row_adres['ulica']; ?>"  required />
                    </div>
                </div>
                   <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Numer</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="numer" value="<?php echo $row_adres['numer']; ?>"  required />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label">Kod pocztowy</label>
                    <div class="col-lg-9">
                        <input class="form-control" type="text" name="kod" value="<?php echo $row_adres['kod_pocztowy']; ?>"  required />
                    </div>
                </div>
                <div class="form-group row">
