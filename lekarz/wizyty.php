            ...
            <div class="row p-3 min-vh-100"> 
                <div class="col-md-12 p-3" id="content">
                    <div class="col-md-7 mx-auto">
                        ...
                        <?php
                            include('../connect.php');
                            $wizyty = pg_query_params($dbconn, 'SELECT * from lekarz_wizyty WHERE id_lekarz=$1 ORDER BY data, godzina;', array((int)$_SESSION['id_lekarz'])) or die('Query failed: ' . pg_last_error());;
                        ...
                        <div class="card m-3">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <a href="profil_pacjent.php?id=<?php echo $row['id_pacjent']; ?>" class="btn btn-primary"><i class="fas fa-user-injured"></i>Profil pacjenta</a>
                                </p>
                            </div>
                        </div>
                        <?php } ?>
