<?php
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="wybierz_placowka.php">Wybierz po placówkach</a>
            <a class="dropdown-item" href="wyszukaj_lekarza.php">Wyszukaj lekarza</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="wyswietl_wizyty.php">Twoje wizyty</a>
            </div>
        </li>
        <li class="nav-item">
