...
<html lang="pl">
    ...
    <body>
        ...
        <?php
            include('../../connect.php');    
            $query = pg_query_params($dbconn, 'SELECT * from lekarz WHERE id_lekarz=$1;', array($id_lekarz )) or die('Query failed: ' . pg_last_error());;
            ...
            <div class="row p-3 min-vh-100"> 
                <div class="col-md-12 p-3" id="content">
                    <div class="col-md-8 mx-auto">
						...
						<?php
                                    include('connect.php');
                                    $query = pg_query_params($dbconn, 'SELECT * from lekarz_dyzury WHERE id_lekarz=$1 ORDER BY dzien;', array($id_lekarz)) or die('Query failed: ' . pg_last_error());;
                                    while ($row = pg_fetch_assoc($query)) 
                                    {
                                ?>
				        <div class="card mb-3">
            			    ...
            			    <div class="card-body">
								...
								<div class="row">
			                        <div class="col-sm-5">
								  		<a href="wybierz_godzina_poradnia.php?id=<?php echo $row['id_dyzur']; ?>" class="btn btn-success"><i class="far fa-check-square m-2"></i>Umów wizytę</a>
									</div>
								</div>
                            </div>
              		    </div>
